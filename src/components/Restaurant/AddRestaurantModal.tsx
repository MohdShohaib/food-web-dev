...
export function AddRestaurantModal({
  ...
  return (
    <>
      ...
      {/* Slide-over Panel */}
      <div className="fixed inset-y-0 right-0 w-full max-w-5xl bg-white shadow-2xl z-50 transform transition-transform duration-300 ease-in-out flex flex-col">
        {/* Header */}
        <div className="flex items-center justify-between px-8 py-6 border-b border-gray-100">
          <div>
            <button
              onClick={onClose}
              className="text-xs font-bold text-gray-400 hover:text-gray-600 mb-2 uppercase tracking-wide flex items-center gap-1"
            >
              ← GO BACK
            </button>
